ctSpaces 6.0.1.0 - Internal colleague release
...
The manually started Quick tour highlights real launcher controls without
...
This internal build is unsigned. Follow your organization's software policy.

Cleanup permanently deletes live client data after confirmation. Archived
...
Repository review evidence and test boundaries: docs/RELEASE_VALIDATION_6.0.1.0.md
